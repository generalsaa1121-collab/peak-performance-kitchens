...
export function MealCard({ meal }: { meal: Meal }) {
  ...
  return (
    <motion.article
      ...
      className="group relative flex flex-col overflow-hidden rounded-card border border-white/10 bg-ink-800 transition-[border-color,box-shadow] duration-300 hover:border-green/50 hover:shadow-lift"
    >
      {/* Image → opens detail */}
      <button
        type="button"
