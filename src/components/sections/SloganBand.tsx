    ...
    >
      ...
      <div className="u-container relative py-20 text-center lg:py-24">
        <Reveal className="flex flex-col items-center gap-8">
          {/* Mobile / tablet: official vertical lockup with tagline (fits narrow). */}
          <img
            src={logos.stacked}
            alt={`${brand.name} — ${brand.slogan}`}
            className="w-full max-w-[17rem] sm:max-w-xs lg:hidden"
          />

          {/* Desktop: official horizontal lockup with tagline. */}
          <img
